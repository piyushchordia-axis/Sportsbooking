...
CREATE TYPE "public"."LedgerTxnType" AS ENUM('pack_buy', 'pack_debit', 'pack_refund', 'points_earn', 'points_redeem', 'referral_reward', 'no_show_fee', 'cash_refund', 'open_match_settle', 'pack_expire');--> statement-breakpoint
CREATE TYPE "public"."NotificationType" AS ENUM('booking_created', 'booking_cancelled', 'tournament_registration', 'open_match_join', 'amc_reminder', 'general');--> statement-breakpoint
...
CREATE TYPE "public"."PaymentTxnType" AS ENUM('capture', 'refund');--> statement-breakpoint
...
CREATE TYPE "public"."TournamentMatchStatus" AS ENUM('pending', 'completed');--> statement-breakpoint
...
CREATE TABLE "bookings" (
	...
	"amountPaidOnline" numeric(12, 2) DEFAULT '0' NOT NULL,
	"amountDueAtVenue" numeric(12, 2) DEFAULT '0' NOT NULL,
	"packId" text,
	"offerId" text,
...
CREATE TABLE "membership_packs" (
	...
	"venueIds" text[] DEFAULT '{}'::text[],
	"unitIds" text[] DEFAULT '{}'::text[],
	"active" boolean DEFAULT true NOT NULL,
	"createdAt" timestamp (3) DEFAULT CURRENT_TIMESTAMP NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "offer_redemptions" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "offers" (
	"id" text PRIMARY KEY NOT NULL,
	"ownerId" text NOT NULL,
	"name" text NOT NULL,
...
CREATE TABLE "otp_verify_attempts" (
	...
	"windowStartedAt" timestamp (3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE "owners" (
	...
	"allowedGameIds" text[] DEFAULT '{}'::text[],
	"featureFlags" text[] DEFAULT '{}'::text[],
	"logoUrl" text,
...
--> statement-breakpoint
ALTER TABLE "saved_venues" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "slots" (
	"id" text PRIMARY KEY NOT NULL,
	"unitId" text NOT NULL,
	"ownerId" text NOT NULL,
...
CREATE TABLE "tournament_matches" (
	...
	"scoreB" integer,
	"winnerId" text,
	"status" "TournamentMatchStatus" DEFAULT 'pending' NOT NULL,
	"nextMatchId" text,
	"nextSlot" text,
	"createdAt" timestamp (3) DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
CREATE TABLE "users" (
	...
	"mobile" text,
	"passwordHash" text,
	"assignedVenueIds" text[] DEFAULT '{}'::text[],
...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."owners"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "offer_redemptions" ADD CONSTRAINT "offer_redemptions_offerId_fkey" FOREIGN KEY ("offerId") REFERENCES "public"."offers"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "offer_redemptions" ADD CONSTRAINT "offer_redemptions_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "public"."bookings"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "offer_redemptions" ADD CONSTRAINT "offer_redemptions_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."owners"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "saved_venues" ADD CONSTRAINT "saved_venues_venueId_fkey" FOREIGN KEY ("venueId") REFERENCES "public"."venues"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "saved_venues" ADD CONSTRAINT "saved_venues_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "saved_venues" ADD CONSTRAINT "saved_venues_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "public"."owners"("id") ON DELETE restrict ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "addons_ownerId_idx" ON "addons" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "addons_venueId_idx" ON "addons" USING btree ("venueId");--> statement-breakpoint
CREATE INDEX "audit_logs_ownerId_idx" ON "audit_logs" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "bookable_units_ownerId_idx" ON "bookable_units" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "bookable_units_venueId_idx" ON "bookable_units" USING btree ("venueId");--> statement-breakpoint
CREATE INDEX "booking_addons_addonId_idx" ON "booking_addons" USING btree ("addonId");--> statement-breakpoint
CREATE INDEX "booking_addons_bookingId_idx" ON "booking_addons" USING btree ("bookingId");--> statement-breakpoint
CREATE INDEX "bookings_customerId_idx" ON "bookings" USING btree ("customerId");--> statement-breakpoint
CREATE UNIQUE INDEX "bookings_idempotencyKey_key" ON "bookings" USING btree ("idempotencyKey");--> statement-breakpoint
CREATE INDEX "bookings_offerId_idx" ON "bookings" USING btree ("offerId");--> statement-breakpoint
CREATE INDEX "bookings_ownerId_idx" ON "bookings" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "bookings_packId_idx" ON "bookings" USING btree ("packId");--> statement-breakpoint
CREATE INDEX "bookings_seriesId_idx" ON "bookings" USING btree ("seriesId");--> statement-breakpoint
CREATE INDEX "bookings_venueId_idx" ON "bookings" USING btree ("venueId");--> statement-breakpoint
CREATE UNIQUE INDEX "game_catalogue_name_key" ON "game_catalogue" USING btree ("name");--> statement-breakpoint
CREATE INDEX "ledger_txns_customerId_lane_idx" ON "ledger_txns" USING btree ("customerId","lane");--> statement-breakpoint
CREATE INDEX "ledger_txns_ownerId_idx" ON "ledger_txns" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "membership_packs_ownerId_idx" ON "membership_packs" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "notifications_ownerId_idx" ON "notifications" USING btree ("ownerId");--> statement-breakpoint
CREATE UNIQUE INDEX "offer_redemptions_bookingId_key" ON "offer_redemptions" USING btree ("bookingId");--> statement-breakpoint
CREATE INDEX "offer_redemptions_offerId_idx" ON "offer_redemptions" USING btree ("offerId");--> statement-breakpoint
CREATE INDEX "offer_redemptions_offer_customer_idx" ON "offer_redemptions" USING btree ("offerId","customerId");--> statement-breakpoint
CREATE UNIQUE INDEX "offers_ownerId_code_key" ON "offers" USING btree ("ownerId","code");--> statement-breakpoint
CREATE INDEX "offers_ownerId_idx" ON "offers" USING btree ("ownerId");--> statement-breakpoint
CREATE UNIQUE INDEX "open_match_join_requests_matchId_playerId_key" ON "open_match_join_requests" USING btree ("matchId","playerId");--> statement-breakpoint
CREATE UNIQUE INDEX "open_matches_bookingId_key" ON "open_matches" USING btree ("bookingId");--> statement-breakpoint
CREATE INDEX "open_matches_ownerId_idx" ON "open_matches" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "otp_requests_mobile_createdAt_idx" ON "otp_requests" USING btree ("mobile","createdAt");--> statement-breakpoint
CREATE UNIQUE INDEX "owner_customers_ownerId_customerId_key" ON "owner_customers" USING btree ("ownerId","customerId");--> statement-breakpoint
CREATE INDEX "owner_customers_ownerId_idx" ON "owner_customers" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "password_reset_tokens_expiresAt_idx" ON "password_reset_tokens" USING btree ("expiresAt");--> statement-breakpoint
CREATE INDEX "payments_ownerId_idx" ON "payments" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "payments_refType_refId_idx" ON "payments" USING btree ("refType","refId");--> statement-breakpoint
CREATE UNIQUE INDEX "player_profiles_ownerId_customerId_key" ON "player_profiles" USING btree ("ownerId","customerId");--> statement-breakpoint
CREATE INDEX "player_profiles_ownerId_idx" ON "player_profiles" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "pricing_rules_ownerId_idx" ON "pricing_rules" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "pricing_rules_unitId_idx" ON "pricing_rules" USING btree ("unitId");--> statement-breakpoint
CREATE UNIQUE INDEX "referrals_ownerId_code_key" ON "referrals" USING btree ("ownerId","code");--> statement-breakpoint
CREATE INDEX "referrals_ownerId_idx" ON "referrals" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "revoked_refresh_tokens_expiresAt_idx" ON "revoked_refresh_tokens" USING btree ("expiresAt");--> statement-breakpoint
CREATE UNIQUE INDEX "saved_venues_customerId_venueId_key" ON "saved_venues" USING btree ("customerId","venueId");--> statement-breakpoint
CREATE INDEX "saved_venues_customerId_idx" ON "saved_venues" USING btree ("customerId");--> statement-breakpoint
CREATE INDEX "saved_venues_ownerId_idx" ON "saved_venues" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "slots_bookingId_idx" ON "slots" USING btree ("bookingId");--> statement-breakpoint
CREATE INDEX "slots_ownerId_idx" ON "slots" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "slots_unitId_startsAt_idx" ON "slots" USING btree ("unitId","startsAt");--> statement-breakpoint
CREATE UNIQUE INDEX "slots_unitId_startsAt_key" ON "slots" USING btree ("unitId","startsAt");--> statement-breakpoint
CREATE INDEX "tournament_matches_ownerId_idx" ON "tournament_matches" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "tournament_matches_tournamentId_idx" ON "tournament_matches" USING btree ("tournamentId");--> statement-breakpoint
CREATE INDEX "tournament_participants_tournamentId_idx" ON "tournament_participants" USING btree ("tournamentId");--> statement-breakpoint
CREATE INDEX "tournaments_ownerId_idx" ON "tournaments" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "tournaments_venueId_idx" ON "tournaments" USING btree ("venueId");--> statement-breakpoint
CREATE UNIQUE INDEX "users_email_key" ON "users" USING btree ("email");--> statement-breakpoint
CREATE UNIQUE INDEX "users_mobile_key" ON "users" USING btree ("mobile");--> statement-breakpoint
CREATE INDEX "users_ownerId_idx" ON "users" USING btree ("ownerId");--> statement-breakpoint
CREATE INDEX "venues_city_idx" ON "venues" USING btree ("city");--> statement-breakpoint
CREATE INDEX "venues_ownerId_idx" ON "venues" USING btree ("ownerId");--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "notifications" AS PERMISSIVE FOR ALL TO public USING ((app_bypass_rls() OR ("ownerId" = app_current_owner_id()))) WITH CHECK ((app_bypass_rls() OR ("ownerId" = app_current_owner_id())));--> statement-breakpoint
CREATE POLICY "tenant_isolation" ON "offer_redemptions" AS PERMISSIVE FOR ALL TO public USING ((app_bypass_rls() OR ("ownerId" = app_current_owner_id()))) WITH CHECK ((app_bypass_rls() OR ("ownerId" = app_current_owner_id())));--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "payments" AS PERMISSIVE FOR ALL TO public USING ((app_bypass_rls() OR ("ownerId" = app_current_owner_id()))) WITH CHECK ((app_bypass_rls() OR ("ownerId" = app_current_owner_id())));--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "saved_venues" AS PERMISSIVE FOR ALL TO public USING ((app_bypass_rls() OR ("ownerId" = app_current_owner_id()))) WITH CHECK ((app_bypass_rls() OR ("ownerId" = app_current_owner_id())));--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "tournament_matches" AS PERMISSIVE FOR ALL TO public USING ((app_bypass_rls() OR ("ownerId" = app_current_owner_id()))) WITH CHECK ((app_bypass_rls() OR ("ownerId" = app_current_owner_id())));--> statement-breakpoint
...
CREATE POLICY "tenant_isolation" ON "venue_games" AS PERMISSIVE FOR ALL TO public USING ((app_bypass_rls() OR (EXISTS ( SELECT 1
  ...
  WHERE ((v.id = venue_games."venueId") AND (v."ownerId" = app_current_owner_id())))))) WITH CHECK ((app_bypass_rls() OR (EXISTS ( SELECT 1
   FROM venues v
  WHERE ((v.id = venue_games."venueId") AND (v."ownerId" = app_current_owner_id()))))));--> statement-breakpoint
