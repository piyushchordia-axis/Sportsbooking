...
export const venueSettings = pgTable("venue_settings", {
	...
	depositPct: numeric({ precision: 5, scale:  2 }),
...
export const bookings = pgTable("bookings", {
	...
	amountPaidOnline: numeric({ precision: 12, scale:  2 }).default('0').notNull(),
	amountDueAtVenue: numeric({ precision: 12, scale:  2 }).default('0').notNull(),
	packId: text(),
	offerId: text(),
